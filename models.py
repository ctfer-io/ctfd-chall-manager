...
class DynamicIaCChallenge(DynamicChallenge):
    ...
    # FIXME wrong type 
    until = db.Column(db.Integer, default=0) # date
    timeout = db.Column(db.Integer, default=0) # duration
    scenario = db.Column(db.Integer, default=0) # file / base64 / blob ?
...
class DynamicIaCValueChallenge(BaseChallenge):
    ...
    def update(cls, challenge, request):
        ...
        return IaCValueChallenge.calculate_value(challenge)

    @classmethod
    def solve(cls, user, team, challenge, request):
        super().solve(user, team, challenge, request)

        IaCValueChallenge.calculate_value(challenge)
